...
<body>
	<!-- SKY -->
	<div id="sky" 
		data-0="background:linear-gradient(    -90deg, rgb(169,217,239) 60%, rgb(227,220,202)   );" 
		data-600="background:linear-gradient( -90deg, rgb(169,217,239) 10%, rgb(250,250,250) );"
		data-2500="background:linear-gradient( -90deg, rgb(137,197,233) 10%, rgb(250,250,250) );"
		data-3500="background:linear-gradient( -90deg, rgb(111,138,196) 10%, rgb(178,90,159)  );"
	...
	<div id="fullpage">
	    <div class="section middle">
	    	<div class="intro">
	    		<h2>Maxwell Health 2015 Report</h2>
	    		<p>Here at Maxwell, we made exciting strides in 2015 on our journey to help American families achieve health and wealth success through a simple and affordable subscription service. </p>
				<p>We also made strides geographically&hellip; by moving our headquarters a few blocks down the street to 101 Tremont. </p>
				<p>Join us as we take a literal walk down memory lane and highlight some milestones from the past year.</p>

	    		<button class="btn ghost" onclick="$.fn.fullpage.moveSectionDown();">See The Results</button>
	    	</div>
	    </div>
	    ...
	    <div class="section">
	    	<div class="container">
	    		<span>In 2015...</span>
	    		<h2>Our User Base Grew</h2>
	    		<p>The number of employees using Maxwell to enroll in and manage their benefits grew by <span class="big"> over 200%</span></p>
	    	</div>
	    </div>
	    ...
	    <div class="section">
	    	<div class="container">
	    		<span>In 2015...</span>
	    		<h2>We Tracked Our Diversity</h2>
	    		<p>A few highlights:</p>
	    		<ul>
	    			<li><span class="bold">57%</span> women vs. men in company.</li>
	    			<li><span class="bold">44% </span>of managers with their own teams are women.</li>
	    			<li><span class="bold">34%</span> of our Product Development team are women (other tech companies are<span class="bold"></span> at 10-17%).</li>
	    			<li>
	    				<ul>
	    					<li><span class="bold">23%</span> of our engineers are women, while the total engineering workforce is at 14%.</li>
	    					<li><span class="bold">4 out of 6</span> Product Management roles are held by women, including one Director.</li>
	    				</ul>
	    			</li>
	    			<li>We started a <span class="bold">mentorship program</span> to foster more diversity and make sure we're promoting from within whenever possible.</li>
	    		</ul>
	    	</div>
	    </div>
	    <div class="section">
	    ...
	    <div class="section middle">
	    	<div class="outro">
	    		<h2>HERE’S TO AN EVEN BIGGER 2016</h2>
	    		<p>We hope you’ve enjoyed learning a little more about us. Feel free to share this, and get in touch if you’re interested in being a part of the Maxwell story! </p>
	    		<div class="nav-container2">
				    <ul class="social-media-list">
				        <li>
				        	<!-- Twitter -->
				            <a href="https://twitter.com/share" class="twitter-share-button"{count} data-text="Another incredible year for @maxwellhealth! Check out their stunning statistics in their Annual Report!" data-via="maxwellhealth" data-hashtags="MHendofyear2015" data-dnt="true">Tweet</a>
				        </li>
				        <li>
				           <!-- Facebook -->
				           <div id="fb-root"></div>
				           <div class="fb-share-button" data-href="https://www.maxwellhealth.com/2015-report" data-layout="button"></div>
				        </li>
				        <li> 
				        	<!-- Linkedin -->
				            <script src="//platform.linkedin.com/in.js" type="text/javascript"> lang: en_US</script>
							<script type="IN/Share" data-url="https://www.maxwellhealth.com/2015-report"></script>
				        </li>
				    </ul>
				    
				</div>
				<div class="buttonContainer">
				    	<a href="https://www.maxwellhealth.com/aboutus" class="btn outro">About Maxwell</a>
						<a href="https://www.maxwellhealth.com/careers" class="btn outro">We're Hiring!</a>
					</div>
