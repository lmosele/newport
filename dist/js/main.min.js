...
// Our spinning object thingy canvas
var canvas = document.getElementById("cube"),
    ctx = canvas.getContext('2d'),
    points = [],
    r = 0;
    var a = 20; //point seeds
    var b = 10; 
    var d = 20; 
    var minDist = 200;  //distance to connect
    var dist; 
...
function render(){
    ...
    ctx.strokeStyle = 'rgba(255, 255, 255,'+ 1.0 +')'; //object colors
    ctx.fillStyle = '#fff'; //point colors
    ctx.lineWidth = 1;
    ctx.beginPath();
